...
define(['dojo/_base/declare',
        ...
        // '@google/earthengine',
        "dijit/Dialog"],
function(declare,executeAll, map, arcgisPortal,Print, PrintTemplate, esriConfig, on, dom, domStyle,lang,domConstruct,esriRequest,html,array,domGeom, query, Query, QueryTask,FeatureLayer,
         ...
         domAttr, easing, Chart, Chart2D, Default, Pie, LinesPlot, blue, green, MoveSlice, Highlight, Tooltip, ColumnsPlot, ClusteredColumns, Markers,
 ...
 //end of ndvi
      ...
      on(searchAkah,'select-result', function(akahsearchResult_response) {
          ...
          domAttr.set('akahLocation_info','innerHTML',"<span><span class='akahHeadings'>State: </span><span class='akahNames'>"+stateName+"</span></span>&nbsp;&nbsp;<span><span class='akahHeadings'>District: </span><span class='akahNames'>"+districtName+"</span></span>&nbsp;&nbsp;"+
                      "<span><span class='akahHeadings'>Block: </span><span class='akahNames'>"+blockName+"</span></span>&nbsp;&nbsp;<span><span class='akahHeadings'>Village: </span><span class='akahNames'>"+villageName+"</span>");
      ...
      tabsakah = new TabContainer3({
        tabs: [akahinfo1_tab, akahinfo2_tab, akahinfo3_tab, akahinfo4_tab]
      }, this.akah_container);
      ...
      wells_container = new TabContainer3({
            ...
            if(evt != "Select Block" && evt != ""){
              ...
              rainfall_values.forEach(function(evt, index){
                  ...
                  if (fieldname.includes('_actual')) {
                    rain_tooltip_arr_1.push({text: fieldname.slice(0,8).toUpperCase(), value: (akahRainfallResponse.attributes[fieldname])*(-1)});//window.rain_tooltip_arr_1 = rain_tooltip_arr_1;
                    ...
                    rain_months.push({text: fieldname.slice(0,8).toUpperCase(), value: i});//window.rain_months = rain_months;
      ...
      wqDialog = new Dialog({title: "Land Use Land Cover",content:'',style: "width: 300px"});
    ...
    rainfallChartCreate: function(){
      ...
      if(rain_months.length>0){
        ...
        // gwl = gwl.reverse();
        rain_chart.addAxis("x", { fixLower: "major", fixUpper: "major", natural: false, vertical: false, title: "TIME", titleFontColor: "darkblue", labels: rain_months, rotation: 90, titleOrientation: "away", majorLabels: true,majorTicks:true,majorTickStep:1});
        rain_chart.addAxis("y", { /*min: Math.min.apply(null, a), max: Math.max.apply(null, a),*/vertical: true, fixLower: "minor", fixUpper: "minor", title: "Rainfall(in mm)", titleFontColor: "darkblue",minorTicks:false});
        ...
        var zoom_pan = new MouseZoomAndPan(rain_chart, "default", {axis: "x"});
         ...
         rain_chart.titleFont= "bold 12pt Avenir Light"
        ...
        bar_chart_2.addPlot("default", { type: "Columns", gap: 80, width: 20, animate: { duration: 2000, easing: dojo.fx.easing.bounceInOut } });  // Add the only/default plot
        ...
        var chartData_2 = [{ y: irrig_draf_2013,fill: "green", tooltip: irrig_draf_2013 },{ y: draft_irrg_2017 ,fill: "blue", tooltip:draft_irrg_2017 }];
        bar_chart_2.addAxis("x", { fixLower: "minor", fixUpper: "minor", natural: true, vertical: false, title: "", titleFontColor: "black", titleOrientation: "away", labels: [{value: 1, text:'Net GW Availability (2025)', fill:"blue"}, {value: 2, text:'Domestic Future Draft', fill:"blue"}] });
        bar_chart_2.addAxis("y", { min: Math.min.apply(null, barChartData1), max: Math.max.apply(null, barChartData1),vertical: true, fixLower: "major", fixUpper: "major", includeZero: true, title: "Volume(Ham)", titleFontColor: "black" });
      ...
      c.addPlot("default", {type: "Columns",tension: 3,gap: 30, width:20,animate: { duration: 2000, easing: dojo.fx.easing.bounceInOut }});
      c.addAxis("x", {minorTicks:false,majorTicks:true,labels: [{value: 1,text: "Net GW Availability"}, {value: 2,text: "Net Utilization"}, {value: 3,text: "GW for future use"}],fixLower: "major",fixUpper: "major"});
      c.addAxis("y", {vertical: true,fixLower: "major",fixUpper: "major", title: "Volume(Ham)", titleFontColor: "black"});
      c.setTheme(dojox.charting.themes.Wetland);
      c.addSeries("Larger", [{y: "",x: 1,tooltip: "Net GW Availability: "+akahRainfallResponse.attributes.res,text: "Net GW Availability",stroke: {color: "blue",width: 2},fill: "blue"}]);
      c.addSeries("Splited 1", [{x: 1,y: 0}, {y: 487.645, x: 2,tooltip: "Domestic Draft :  487.645",text: "Domestic Draft"}],{stroke: {color: "orange",width: 2},fill: "orange"});
      c.addSeries("Splited 2", [{x: 1,y: 1}, {y: 8602.39, x: 2,tooltip: "Irrigation Draft :  8602.39",text: "Irrigation Draft",color: "green",stroke: {color: "green",width: 2}}]);
      c.addSeries("Splited 3", [{x: 2,y: 0}, {y: akahRainfallResponse.attributes.res - akahRainfallResponse.attributes.total,x: 3,tooltip: "GW for future use : "+akahRainfallResponse.attributes.gw_alloc,text: "GW for future use"}],{stroke: {color: "#A93226",width: 2},fill: "#A93226"});
      // c.addSeries("Splited 4", [{x: 2,y: 1}, {y: akahRainfallResponse.attributes.gw_alloc + 1000,x: 3,tooltip: "split5",text: "split5",color: "yellow",stroke: {color: "yellow",width: 2}}]);
      var a1 = new dojox.charting.action2d.Tooltip(c, "default");
      c.title = "Estimated Groundwater Resources (Base Line Year - 2017)"
        c.titleFont= "bold 12pt Avenir Light"
        c.titlePos = "top"
        c.titleGap = 10
      c.render();
      c.resize(560,300);
              ...
              ndwi_response.features.forEach(function(ndwi_resp, ndwi_index){
                  ndwi_response.fields.forEach(function(evt, index){
                    ...
                    if (fieldname.includes("date_string") || fieldname.includes("ndwi_min")||fieldname.includes("ndwi_max")||fieldname.includes("ndwi_mean")||fieldname.includes("ndwi_stddev")){
                      ...
                      {ndwidateLabels.push( {text:ndwi_resp.attributes[fieldname], value: ndwi_index+1});}
        ...
        ndvi_response.features.forEach(function(ndvi_resp, ndvi_index){
            ndvi_response.fields.forEach(function(evt, index){
              ...
              if (fieldname.includes("date_string") || fieldname.includes("ndvi_min")||fieldname.includes("ndvi_max")||fieldname.includes("ndvi_mean")||fieldname.includes("ndvi_stddev")){
                ...
                {ndvidateLabels.push( {text:ndvi_resp.attributes[fieldname], value: ndvi_index+1});}
          ...
          if (akahstate !="Select State" && akahdistrict === "Select District" && akahblock === "Select Block" && akahvillage === "Select Village") {
            ...
            akah_villages_layer.setVisibility(true);
             ...
             new QueryTask(akah_block_layer.url).execute(query_selectedInp, function retrieve(response) {
              ...
              if (akahblock === 'Gangapur') {
                  window.res1='<div><p style="font-weight: 600;font-size: 20px;margin: 40px 0px 0px 2px;text-align: center;color: darkblue;">Water Level Trend charts for CGWB Well Sites </p></div>'+
                    akah_Tool.generateMultiPlotChart( [{text:"2015",value: 1}, {text:"2016", value: 2}, {text: "2017", value: 3}, {text:"2018", value: 4}, {text: "2019", value: 5}, {text: "2020", value: 6}],
                    [/*605.25,*/ 592.06, 714.71, 686.51, 438.01, 826.43, 862.41],
                    [/*-13.2265625,*/ -10.296875, -14, -12.5, -11.5, -8.1484375],
                    [/*-5.30078125,*/ -5.3984375, -4.75, -2.06054688, -4, -0.79980469], 'Gangapur-3');
                  res1=res1+akah_Tool.generateMultiPlotChart( [{text:"2015",value: 1}, {text:"2016", value: 2}, {text: "2017", value: 3}, {text:"2018", value: 4}, {text: "2019", value: 5}, {text: "2020", value: 6}],
                    [592.06, 714.71, 686.51, 438.01, 826.43, 862.41],//rainfall
                    [-16.406250, -16.00000, -14.546875, -16.000000, -16.390625],//premonsoon
                    [-14.500000, -15.546875, -13.210938, -15.000000, -15.2500000],'Dahegaon Bangla');//postmonsoon, station name
                  res1 = res1 + '<p style="font-weight: 600;padding: 0px;color: #9e3f07;margin: 1px 0px 0px 55px;">*Sources: District-level Annual rainfall taken from IMD</p>';
              }
              else if (akahblock === 'Malia') {
                  window.res1='<div><p style="font-weight: 600;font-size: 20px;margin: 40px 0px 0px 2px;text-align: center;color: darkblue;">Water Level Trend charts for CGWB Well Sites </p></div>'+
                    akah_Tool.generateMultiPlotChart( [{text:"2015",value: 1}, {text:"2016", value: 2}, {text: "2017", value: 3}, {text:"2018", value: 4}, {text: "2019", value: 5}, {text: "2020", value: 6}],
                    [/*605.25,*/ 750.88,948.82,885.38,904.71,1322.86,1553.63],
                    [/*-13.2265625,*/ -9.1875, -7.9296875, -8.9296875, -8.0078125, -7.828125],
                    [/*-5.30078125,*/ -2.13085938, -5.53125, -6.2890625, -5.98828125, -3.3203125], 'Budecha');
                  res1=res1+akah_Tool.generateMultiPlotChart( [{text:"2015",value: 1}, {text:"2016", value: 2}, {text: "2017", value: 3}, {text:"2018", value: 4}, {text: "2019", value: 5}, {text: "2020", value: 6}],
                    [750.88,948.82,885.38,904.71,1322.86,1553.63],//rainfall
                    [-18.953125, -18.8125, -21.234375, -19.6875, -21.21875],//premonsoon
                    [-19.234375, -7.28125, -13.078125, -17.046875, -8.6171875],'Seriakhan');//postmonsoon, station name
                  res1=res1+akah_Tool.generateMultiPlotChart( [{text:"2015",value: 1}, {text:"2016", value: 2}, {text: "2017", value: 3}, {text:"2018", value: 4}, {text: "2019", value: 5}, {text: "2020", value: 6}],
                    [750.88,948.82,885.38,904.71,1322.86,1553.63],//rainfall
                    [-6.30078125, -8.5078125, -11.7109375, -6.359375, -6.6796875],//premonsoon
                    [-8.4296875, -12.7265625, -13.2265625, -9.453125, -6.578125],'Juthal');//postmonsoon, station name
                  res1=res1+akah_Tool.generateMultiPlotChart( [{text:"2015",value: 1}, {text:"2016", value: 2}, {text: "2017", value: 3}, {text:"2018", value: 4}, {text: "2019", value: 5}, {text: "2020", value: 6}],
                    [750.88,948.82,885.38,904.71,1322.86,1553.63],//rainfall
                    [-18.953125, -18.8125, -21.234375, -19.6875, -21.21875],//premonsoon
                    [-19.234375, -7.28125, -13.078125, -17.046875, -8.6171875],'Gadu');//postmonsoon, station name
                  res1 = res1 + '<p style="font-weight: 600;padding: 0px;color: #9e3f07;margin: 1px 0px 0px 55px;">*Sources: District-level Annual rainfall taken from IMD</p>';
              }
              ...
              window.selected_result=new QueryTask(akah_selectedwells_layer.url).execute(query_selectedInp, function retrieve(summ_selected_records1) {
                ...
                summ_selected_records1.features.forEach(function (feature,sv) {
                  ...
                  // wq_header_text=wq_header_text+"<td>"+"heading"+"</td>"+"<td>"+(feature.attributes["latitude"]==null?'':feature.attributes["latitude"])+"</td>"+
                  // "<td>"+(feature.attributes["longitude"]==null?'':feature.attributes["longitude"])+"</td>"+"<td>"+(feature.attributes["owner_name"]==null?'':feature.attributes["owner_name"])+"</td>"+
                  // "<td>"+(feature.attributes["well_depth_meters"]==null?'':feature.attributes["well_depth_meters"])+"</td>"+"<td>"+(feature.attributes["water_depth_meters"]==null?'':feature.attributes["water_depth_meters"])+"</td></tr>";

                  // wq_tbl3_body=wq_tbl3_body+"<td>"+(sv+1)+"</td>";
                  // wq_tbl4_body=wq_tbl4_body+"<td>"+(sv+1)+"</td>";
                  // wq_tbl5_body=wq_tbl5_body+"<td>"+(sv+1)+"</td>";
                  // wq_tbl6_body=wq_tbl6_body+"<td>"+(sv+1)+"</td>";


                  // wqpar.forEach(function(f,index){
                  //   if(index<=0){
                  //     wq_tbl1_body=wq_tbl1_body+"<td>"+(feature.attributes[f+"_pre_m"]==null?'':feature.attributes[f+"_pre_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_during_m"]==null?'':feature.attributes[f+"_during_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_post_m"]==null?'':feature.attributes[f+"_post_m"])+"</td>";
                  //   }
                  //   else if(index>0 && index<=3){
                  //     wq_tbl2_body=wq_tbl2_body+"<td>"+(feature.attributes[f+"_pre_m"]==null?'':feature.attributes[f+"_pre_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_during_m"]==null?'':feature.attributes[f+"_during_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_post_m"]==null?'':feature.attributes[f+"_post_m"])+"</td>";
                  //   }
                  //   else if(index>3 && index<=6){
                  //     wq_tbl3_body=wq_tbl3_body+"<td>"+(feature.attributes[f+"_pre_m"]==null?'':feature.attributes[f+"_pre_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_during_m"]==null?'':feature.attributes[f+"_during_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_post_m"]==null?'':feature.attributes[f+"_post_m"])+"</td>";
                  //   }
                  //   else if(index>6 && index<=9){
                  //     wq_tbl4_body=wq_tbl4_body+"<td>"+(feature.attributes[f+"_pre_m"]==null?'':feature.attributes[f+"_pre_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_during_m"]==null?'':feature.attributes[f+"_during_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_post_m"]==null?'':feature.attributes[f+"_post_m"])+"</td>";
                  //   }
                  //   else if(index>9 && index<=12){
                  //     wq_tbl5_body=wq_tbl5_body+"<td>"+(feature.attributes[f+"_pre_m"]==null?'':feature.attributes[f+"_pre_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_during_m"]==null?'':feature.attributes[f+"_during_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_post_m"]==null?'':feature.attributes[f+"_post_m"])+"</td>";
                  //   }
                  //   else{
                  //     wq_tbl6_body=wq_tbl6_body+"<td>"+(feature.attributes[f+"_pre_m"]==null?'':feature.attributes[f+"_pre_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_during_m"]==null?'':feature.attributes[f+"_during_m"])+"</td>"+
                  //     "<td>"+(feature.attributes[f+"_post_m"]==null?'':feature.attributes[f+"_post_m"])+"</td>";
                  //   }
                  // });
                      // wq_tbl6_body=wq_tbl6_body+"<td>"+each_well_wq1[sv]+"</td>"+
                      //               "<td>"+each_well_wq2[sv]+"</td>"+
                      //               "<td>"+each_well_wq3[sv]+"</td>"+"</tr>";
                      // wq_tbl1_body=wq_tbl1_body+"</tr>";
                      // wq_tbl2_body=wq_tbl2_body+"</tr>";
                      // wq_tbl3_body=wq_tbl3_body+"</tr>";
                      // wq_tbl4_body=wq_tbl4_body+"</tr>";
                      // wq_tbl5_body=wq_tbl5_body+"</tr>";
                });
                ...
                query_total_village.outFields=["villname","SHAPE__Area"]
                ...
                window.total_village_query=new QueryTask(akah_total_villages.url).execute(query_total_village, function retrieve(village_response) {
                  if(village_response.features.length>0){
                  var vill_area=[]
                  village_response.features.forEach(function(j){
                    vill_area.push(j.attributes["SHAPE__Area"])
                  })
                ...
                window.wr=new QueryTask(akah_main_layer.url).execute(query_summ1, function retrieve(response) {
                    ...
                    window.rf_chart_query=new QueryTask(akah_block_layer.url).execute(queryrf,function(rf_response1){
                      ...
                      // var gwr_res = Number(rf_response.attributes['res'].toFixed(2));
                      // var gwr_total = Number(rf_response.attributes['gw_alloc'].toFixed(2));
                      // var gwr_draftIrr = Number(rf_response.attributes['draft_irrg'].toFixed(2));
                      // var gwr_resDom =Number(rf_response.attributes['res_dom'].toFixed(2));

                      rf_response.attributes['res']!=null ? (gwr_res = Number(rf_response.attributes['res'].toFixed(2))) : gwr_res = ""
                      rf_response.attributes['gw_alloc']!=null ? (gwr_total = Number(rf_response.attributes['gw_alloc'].toFixed(2))) : gwr_total = ""
                      rf_response.attributes['draft_irrg']!=null ? (gwr_draftIrr = Number(rf_response.attributes['draft_irrg'].toFixed(2))) : gwr_draftIrr = ""
                      rf_response.attributes['res_dom']!=null ? (gwr_resDom = Number(rf_response.attributes['res_dom'].toFixed(2))) : gwr_resDom = ""
                      //x axis labels
                      rf_response.attributes['res']!=null ? (gwr_res_label = "*Net GW Availability") : gwr_res_label = "*Net GW Availability (No data)"
                      rf_response.attributes['gw_alloc']!=null ? (gwr_total_label = "Future GW Availability") : gwr_total_label = "Future GW Availability (No data)"
                      rf_response.attributes['draft_irrg']!=null ? (gwr_draftIrr_label = "Irrigation Draft") : gwr_draftIrr_label = "Irrigation Draft (No data)"
                      rf_response.attributes['res_dom']!=null ? (gwr_resDom_label = "Domestic Draft") : gwr_resDom_label = "Domestic Draft (No data)"
                      ...
                      bar_Chart_rep.addAxis("x", { fixLower: "minor", fixUpper: "minor", natural: true, vertical: false, title: "", titleFontColor: "black", titleOrientation: "away",font:"normal normal bold 7pt Arial", fontColor:"black", labels: [{value: 1,text: gwr_res_label, fill:"green"}, 
                      {value: 2,text: 'Natural Discharge', fill:"green"}, {value: 3,text:gwr_total_label, fill:"blue"}, {value: 4, text: gwr_draftIrr_label, fill:"blue"}, {value: 5,text:gwr_resDom_label, fill:"blue"}] });
                      ...
                      "<div style='display:inline-flex;'>"+
                      "<div style='width:17px;height:16px;border:1.6px solid white;background-color:blue;border-radius: 4px;'></div>"+
                      "<span style='padding-left:5px;'>*Net GW Availability</span></div>"+
                      
                      "<div style='display:inline-flex;'>"+
                      "<div style='width:17px;height:16px;border:1.6px solid white;background-color:blue;border-radius: 4px;'></div>"+
                      "<span style='padding-left:5px;'>Total Natural Discharge</span></div>"+

                      "<div style='display:inline-flex;padding-left:10px;'>"+
                      "<div style='width:17px;height:16px;border:1.6px solid white;background-color:blue;border-radius: 4px'></div>"+
                      "<span style='padding-left:5px;'>Net GW Availability for future use</span></div>"+

                      "<div style='display:inline-flex;padding-left:10px;'>"+
                      "<div style='width:17px;height:16px;border:1.6px solid white;background-color:orange;border-radius: 4px;'></div>"+
                      "<span style='padding-left:5px;'>Irrigation Draft</span></div>"+

                      "<div style='display:inline-flex;padding-left:10px;'>"+
                      "<div style='width:17px;height:16px;border:1.6px solid white;background-color:orange;border-radius: 4px;'></div>"+
                      "<span style='padding-left:5px;'>Domestic Draft</span></div>"+
                      ...
                      if(rain_months1.length>0){
                        ...
                        // gwl = gwl.reverse();
                        rain_chart1.addAxis("x", {fixLower: "major", fixUpper: "major", natural: false, vertical: false, title: "TIME", titleFontColor: "darkblue", labels: [{text:"2014",value:1},{text:"2015",value:2},{text:"2016",value:3},{text:"2017",value:4},{text:"2018",value:5},{text:"2019",value:6},{text:"2020",value:7}], rotation: 90, titleOrientation: "away", majorLabels: true,majorTicks:true,majorTickStep:1,font:"normal normal bold 7pt Arial",
                        fontColor:"black"});
                        rain_chart1.addAxis("y", { /*min: Math.min.apply(null, a), max: Math.max.apply(null, a),*/vertical: true, fixLower: "minor", fixUpper: "minor", title: "Rainfall(in mm)", titleFontColor: "darkblue",font:"normal normal bold 7pt Arial",
                        fontColor:"black"});
                        // gwl.setTransform(chart.rotategAt(rotate, x,y));Math.max.apply(null, a)
                  ...
                  //dataForReport.push(baselinannual_checklist);
                      ...
                      window.rep_sel=new QueryTask(akah_selectedwells_layer.url).execute(query_summ2, function retrieve(summ_selected_records1) {
                        ...
                        window.rep_village=new QueryTask(akah_villages_layer.url).execute(query_summ1, function retrieve(summ){
                          ...
                          var akahLulc_DataNew = [{ y: block_lulc_bu, /*text: lulcAL_valNew+"ha",*/ tooltip:"Built Up <b>: " + Number(block_lulc_bu) +"</b>",fill:"#bd3c11", stroke: {color: "#bd3c11", width: 4}},
                          ...
                          akah_BlockLULCchart.addPlot("default", { type: Pie , font: "normal normal bold 12px TimesnewRoman", fontColor: "black", radius: 250, stroke: {width: 1}, labelOffset: -20, labels: true, labelStyle: "default",htmlLabels: true});
                          ...
                          '<span style="padding: 0px 8px 0px 6px;color:#bd3c11;background-color:#bd3c11;font-size: 13px;margin-left:44px;border-radius:3px;">.</span><span>&nbsp;Built Up</span><span style="padding-left: 62px;">- &nbsp;&nbsp;'+block_lulc_bu.toFixed(2)+' ha</span><br>'+
                          '<span style="padding: 0px 8px 0px 6px;color:#2f92a3;border-radius:3px;background-color:#2f92a3;font-size: 13px;margin-left:44px">.</span><span>&nbsp;Water Bodies</span><span style="padding-left: 29px;">- &nbsp;&nbsp;'+block_lulc_wb.toFixed(2)+' ha</span><br>'+
                          '<span style="padding: 0px 8px 0px 6px;color:#047d04;background-color:#047d04;font-size: 13px;margin-left:44px;border-radius:3px;"></span><span>&nbsp;Grass Land</span><span style="padding-left: 40px;">- &nbsp;&nbsp;'+block_lulc_gl.toFixed(2)+' ha</span><br>'+
                          '<span style="padding: 0px 8px 0px 6px;color:#5adf5a;background-color:#5adf5a;font-size: 13px;margin-left: 44px;border-radius:3px;"></span><span>&nbsp;Agriculture Land</span><span style="padding-left: 14px;">- &nbsp;&nbsp;'+block_lulc_al.toFixed(2)+' ha</span><br>'+
                          '<span style="padding: 0px 8px 0px 6px;color:#edd8c0;background-color:#edd8c0;font-size: 13px;margin-left:44px;border-radius:3px;">.</span><span>&nbsp;Barren Land</span><span style="padding-left: 34px;">- &nbsp;&nbsp;'+block_lulc_bl.toFixed(2)+' ha</span></div>')
                          ...
                          akah_areaIrrigChart.addPlot("default", { type: Pie , font: "normal normal bold 12px TimesnewRoman", fontColor: "black", radius: 180, stroke: {width: 1}, labelOffset: -30, labels: true, labelStyle: "default",htmlLabels: true});
                          ...
                          akah_village_IrrigChart.addPlot("default", { type: Pie , font: "normal normal bold 12px TimesnewRoman", fontColor: "black", radius: 180, stroke: {width: 1}, labelOffset: -30, labels: true, labelStyle: "default",htmlLabels: true});
                        ...
                        window.printDistrictMap = new QueryTask(akah_states_layer.url).execute(query_districtKey, function retrieve(response) {
                            ...
                            window.districtMapExtent = new QueryTask(akah_dist_layer.url).execute(query_districtKey, function(districtVar){
                                ...
                                if(districtVar.features.length > 0)
                                {
                    ...
                    if (summ.features[0].attributes['al_dec2020'] != null) {window.lulcAL_valNew = Number(summ.features[0].attributes['al_dec2020']).toFixed(2)}else{window.lulcAL_valNew = 0}
                    if (summ.features[0].attributes['bl_dec2020'] != null) {window.lulcBL_valNew = Number(summ.features[0].attributes['bl_dec2020']).toFixed(2)}else{window.lulcBL_valNew = 0}
                    if (summ.features[0].attributes['bu_dec2020'] != null) {window.lulcBU_valNew = Number(summ.features[0].attributes['bu_dec2020']).toFixed(2)}else{window.lulcBU_valNew = 0}
                    if (summ.features[0].attributes['gl_dec2020'] != null) {window.lulcFR_valNew = Number(summ.features[0].attributes['gl_dec2020']).toFixed(2)}else{window.lulcFR_valNew = 0}
                    if (summ.features[0].attributes['wb_dec2020'] != null) {window.lulcWB_valNew = Number(summ.features[0].attributes['wb_dec2020']).toFixed(2)}else{window.lulcWB_valNew = 0}
                    ...
                    akah_VillageLULCchart.addPlot("default", { type: Pie , font: "normal normal bold 12px TimesnewRoman", fontColor: "black", radius: 250, stroke: {width: 1}, labelOffset: -20, labels: true, labelStyle: "default",htmlLabels: true});
                    ...
                    '<span style="padding: 0px 8px 0px 6px;color:#047d04;background-color:#047d04;font-size: 13px;margin-left:44px;border-radius:3px;"></span><span>&nbsp;Forest Area</span><span style="padding-left: 40px;">- &nbsp;&nbsp;'+lulcFR_valNew+' ha</span><br>'+
                    '<span style="padding: 0px 8px 0px 6px;color:#5adf5a;background-color:#5adf5a;font-size: 13px;margin-left: 44px;border-radius:3px;"></span><span>&nbsp;Agriculture Land</span><span style="padding-left: 14px;">- &nbsp;&nbsp;'+lulcAL_valNew+' ha</span><br>'+
                    '<span style="padding: 0px 8px 0px 6px;color:#edd8c0;background-color:#edd8c0;font-size: 13px;margin-left:44px;border-radius:3px;">.</span><span>&nbsp;Barren Land</span><span style="padding-left: 34px;">- &nbsp;&nbsp;'+lulcBL_valNew+' ha</span><br>'+
                    '<span style="padding: 0px 8px 0px 6px;color:#2f92a3;border-radius:3px;background-color:#2f92a3;font-size: 13px;margin-left:44px">.</span><span>&nbsp;Water Bodies</span><span style="padding-left: 29px;">- &nbsp;&nbsp;'+lulcWB_valNew+' ha</span><br>'+
                    '<span style="padding: 0px 8px 0px 6px;color:#bd3c11;background-color:#bd3c11;font-size: 13px;margin-left:44px;border-radius:3px;">.</span><span>&nbsp;Built Up</span><span style="padding-left: 62px;">- &nbsp;&nbsp;'+lulcBU_valNew+' ha</span></div>')
                   //code for LULC  chart in reports ends
    ...
    generateMultiPlotChart: function(gl1,gl2,gl3,gl4,gl5){
       ...
       //m. b values formulea
        ...
        if(rise_change_pre>0){
          window.change_text_pre = Number(rise_change_pre).toFixed(2)+" (rise)&nbsp;<span><img src='"+rise_arrow+"' style='width: 10px;height: 14px;' alt='rise_image'/></span>";
        }
        else if(rise_change_pre===0){
          window.change_text_pre = "Stable";
        }
        else{
          window.change_text_pre = Number(rise_change_pre).toFixed(2)+" (fall)&nbsp;<span><img src='"+fall_arrow+"' style='width: 10px;height: 14px;' alt='rise_image'/></span>"; 
        }
        ...
        */
        ...
        var temp = '<div style="display:inline-grid;padding-left: 35px;"><p style="font-size:15px;font-weight: 600;text-align: center;">Well Site - '+gl5+' </p>'+
        '<div style="display: flex;padding-left: 110px;"><p style="font-weight: 600;margin: 0px;">Rate of rise/fall:</p><span style="padding-left: 30px;">Pre-monsoon:'+change_text_pre+'</span><span style="padding-left: 30px;">Post-monsoon: '+change_text_post+'</span></div>'+
    ...
    window.printing_tool_exe = BlockPrintTask.execute(blockMapParams, function (evt){
        ...
        if (akahstate === "Maharashtra") {
          info_statement = '<div><p style="font-size: 20px;font-weight: 600;color: darkblue;">Regional Hydrogeology</p>'+
          '<p style="text-align: justify;font-size: 14px;">The concerned region of Aurangabad district is encompassed with hard rock terrains (Deccan Traps) mainly basalts.'+
          'The aquifer system here, relies on secondary porosity developed due to weathering or tectonic activities.'+
          'Major water bearing formations involves alluvium, sand, gravel which supports Phreatic to Semi-confined aquifer system along with river tributaries in the study area.'+
          'The water level fluctuation and aquifer conditions can be monitored using this platform.</p></div>';
        }
        else{
          info_statement = '<div><p style="font-size: 20px;font-weight: 600;color: darkblue;">Regional Hydrogeology</p>'+
        ...
        tableText = {
          ...
          '<br><div style="text-align:center"><img src="'+printres+'" style="width: 100%;margin-top: 40px;margin-bottom: 30px;" alt="block_map"></div>'+"<h2 class='akahReportTableheadings'>1. Block Profile</h2>" +
          ...
          "<tr><td>1.</td><td class='ReportTable_subHdngs'>No. of surface water bodies (like farm ponds, tanks, etc)</td><td>"+rv["surface_water_bodies_count_block"]+"</td></tr>" +
          ...
          "</table>"+
          '<div>'+
          '<span style="font-size:13px;color: #9e3f07;padding-right: 26px;font-weight: 600;margin:0px">'+
          '*Assumptions based on CGWB field reports: Depth of water bodies= 1.5 m</span>'+
          '<span style="font-size:11px;padding-right: 26px;color: #9e3f07;font-weight: 600;margin:0px">'+
          ...
          '<p style="font-weight: 600;font-size: 20px;text-align: center;margin: 0px;">Block Level Aquifer map - '+akahblock+'</p><div style="text-align:center"><img src="'+printres1+'" style="width: 100%;" alt="block_map"></div>'+
           info_statement+res1+
          ...
          "<div style='display:inline-flex;padding-bottom:15px;padding-top:50px;width:100%'>"+
          ...
          "</div>"+
          "</div></div>"+"<p class='ReportTable_subHdngs' style='font-size: larger;padding-left: 60px;'>Net Sown area (in ha) = "+(rv["block_areairr_canals"]+rv["block_areairr_wells"])+"</p>"+
        ...
        tableText1 = {
          ...
          "<p style='padding-left: 30px;font-size: 18px;font-weight: 600;'>b. Estimated Groundwater Resources</p>"+
          '<div>'+rep_bar_chart+'</div>'+'<p style="font-weight: 600;color: #9e3f07;padding: 0px;margin: 1px 0px 0px 55px;">*Source: CGWB Groundwater Resources Report (2017)</p>'+
          ...
          '<div style="flex:7;">'+'<img src="'+gw_3dimage+'" style="width: 100%;" alt="gw_3dimage">'+'</div></div>'+
          "<div><h2 class='akahReportTableheadings'>Land Use Land Cover </h2></div>"+
        ...
        village_tableText = {
          ...
          "<h2 style='text-align:center;' class='akahReportTableheadings'>Village Profile: "+akahvillage+"</h2>" +
          "<table class='akahReportTable1' style='margin-bottom: 10px;'>" +
          ...
          "<tr><td>2.</td><td class='ReportTable_subHdngs'>Village area(in ha)</td><td colspan=3>"+rep_vil7_1+"</td></tr>" +
          "<tr><td>3.</td><td class='ReportTable_subHdngs'>Village population</td><td colspan=3>"+rep_vil3+"</td></tr>" +
          ...
          "<table class='akahReportTable1'>" +
          "<tr><td>1.</td><td class='ReportTable_subHdngs'>No. of surface water bodies (like farm ponds, tanks,etc)</td><td style='width:45%'>"+rv["surface_water_bodies_count"]+"</td></tr>"+
        ...
        village_tableText1 = {
          ...
          well_table +
          // "<tr><td class='ReportTable_subHdngs1' rowspan='2'>Well ID</td>"+
          // "<td class='ReportTable_subHdngs1' rowspan='2'>Latitude</td>"+
          // "<td class='ReportTable_subHdngs1' rowspan='2'>Longitude</td>"+
          // "<td class='ReportTable_subHdngs1' rowspan='2'>Owner Name</td>"+
          // "<td class='ReportTable_subHdngs1' rowspan='2'>Well Depth (m)</td>"+
          // //"<td class='ReportTable_subHdngs1' rowspan='2'>Water Depth (in m)</td>"+
          // "<td class='ReportTable_subHdngs1' colspan='2'>Water Depth - Oct_2020 (m)</td>"+
          // "<td class='ReportTable_subHdngs1' colspan='2'>Water Depth - Nov_2020 (m)</td>"+
          // "<td class='ReportTable_subHdngs1' colspan='2'>Water Depth - Dec_2020 (m)</td>"+
          // "<td class='ReportTable_subHdngs1'  colspan='2'>Water Depth - Jan_2021 (m)</td>"+
          // "<td class='ReportTable_subHdngs1'  colspan='2'>Water Depth - Feb_2021 (m)</td>"+
          // "<td class='ReportTable_subHdngs1'  colspan='2'>Water Depth - Mar_2021 (m)</td>"+
          // "<td class='ReportTable_subHdngs1'  colspan='2'>Water Depth - Apr_2021 (m)</td>"+
          // "</tr>"+
          // "<tr>"+
          // "<td class='ReportTable_subHdngs1'>1</td>"+
          // "<td class='ReportTable_subHdngs1'>2</td>"+
          // "<td class='ReportTable_subHdngs1'>1</td>"+
          // "<td class='ReportTable_subHdngs1'>2</td>"+
          // "<td class='ReportTable_subHdngs1'>1</td>"+
          // "<td class='ReportTable_subHdngs1'>2</td>"+
        ...
        lulc_tableText = {
          ...
          "<div><h2 class='akahReportTableheadings'>6. Land Use Land Cover </h2></div>"+
          '<div style="padding-left:2%;font-size: larger;background-color: #f9f8f8;margin: 0px 30px 0px 30px;padding: 8px;border-radius: 10px;"><span class="ReportTable_subHdngs"> State: &nbsp;</span>'+
          '<span style="color: #50a184;font-weight: 600;">'+akahstate+'</span>&nbsp;&nbsp;<span class="ReportTable_subHdngs"> District: &nbsp;</span>'+
          '<span style="color: #50a184;font-weight: 600;">'+akahdistrict+'</span>&nbsp;&nbsp;<span class="ReportTable_subHdngs"> Block: &nbsp;</span>'+
          '<span style="font-weight: 600;color: #50a184;font-weight: 600;">'+akahblock+'</span>&nbsp;&nbsp;<span class="ReportTable_subHdngs"> Village: &nbsp;</span>'+
    ...
    displayWQInfo: function(){
      on(dom.byId("infobtn_WQ"),"click", function(evt){
          wqDialog.set("content",'Water quality information resides here!!!');
